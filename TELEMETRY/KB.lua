...
local data = {}
--data.vfasid =       TelemetryValue.getTelemetryId("VFAS")
--data.A4id =         TelemetryValue.getTelemetryId("A4")
--data.celsid =       TelemetryValue.getTelemetryId("Cels")
--data.gpsaltid =     TelemetryValue.getTelemetryId("GAlt") 
--data.altid =        TelemetryValue.getTelemetryId("Alt") 
--data.spdid =        TelemetryValue.getTelemetryId("GSpd")
--data.gpsid =        TelemetryValue.getTelemetryId("GPS")
--data.currentid =    TelemetryValue.getTelemetryId("Curr")
--data.rssiId =       TelemetryValue.getTelemetryId("RSSI")
--data.headingid =    TelemetryValue.getTelemetryId("Hdg")
--data.fuelid =       TelemetryValue.getTelemetryId("Fuel")
--data.tmp2id =       TelemetryValue.getTelemetryId("Tmp2")
--data.tmp1id =       TelemetryValue.getTelemetryId("Tmp1")
...
local function GetnewTelemetryValue()
  ...
  --data.A4 =         getValue(data.A4id)
  --data.galt =       getValue(data.gpsaltid)
  ...
  --data.Tmp2 =       getValue(data.tmp2id)
  --data.Tmp1 =       getValue(data.tmp1id)
end
...
local function backgroundwork()
  ...
  if menu.currentItem == 2 and lastMenuEvent + MENU_TIMESLICE < getTime() then
    background.run_bg()
    collectgarbage()
  end
